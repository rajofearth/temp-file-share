...
| `access_grant.create`         | A Modal admin requested time-limited access to a workspace.                                                                                                                                                                                                         |
...
| `user.set_approval`           | A user's workspace-membership approval state was changed. The new approved/unapproved value is recorded in the event metadata.                                                                                                                                      |
